...
`go install github.com/consbio/mbtileserver@v0.6.1`

Please note: there's an incompatibility in newer versions, the service doesn't return the id property, which FE depends on.
