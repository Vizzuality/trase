...
INDONESIA_LOGISTICS_MAP_ACTIVE: if set to true, only Indonesia data will be shown in the logistics map.
...
#### More
- [Generating CARTO maps](docs-backend-generating-carto-maps)
