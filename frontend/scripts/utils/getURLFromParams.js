...
export const GET_NODES_WITH_SEARCH = 'GET_NODES_WITH_SEARCH';
...
export const GET_SEARCH_NODES_URL = 'GET_SEARCH_NODES_URL';
...
const API_ENDPOINTS = {
  ...
  [GET_NODES_WITH_SEARCH]: { api: 3, endpoint: '/nodes/search' },
  ...
  [GET_SEARCH_NODES_URL]: { api: 3, endpoint: '/nodes/search' }
};
