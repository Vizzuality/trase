...
const toolReducerTypes = PropTypes => ({
  ...
  selectedMapContextualLayers: PropTypes.object,
  selectedMapDimensions: PropTypes.array.isRequired,
  selectedMapDimensionsWarnings: PropTypes.object,
  ...
  selectedNodesGeoIds: PropTypes.arrayOf(PropTypes.number).isRequired,
