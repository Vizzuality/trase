...
export const getVersionData = createSelector(getSelectedContext, selectedContext => {
  if (!selectedContext) return null;
  return versionJson.find(version => version.context_id === selectedContext.id);
});

export const getTableData = createSelector(getVersionData, contextVersionData => {
