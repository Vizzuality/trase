...
export default (className, {
  topoJSONPath, topoJSONRoot, getPolygonClassName, showTooltipCallback, hideTooltipCallback, useRobinsonProjection
}) => {
  ...
  const width = parseInt(containerComputedStyle.width, 10);
  const height = parseInt(containerComputedStyle.height, 10);
