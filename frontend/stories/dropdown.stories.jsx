...
storiesOf('Dropdown', module).addWithJSX('Dropdown', () => (
...
storiesOf('Dropdown', module).addWithJSX('variant sentence', () => (
  <div className="components-container -spaced -width-200">
    <State store={store}>
      <Dropdown
        variant="sentence"
...
storiesOf('Dropdown', module).addWithJSX('variant panel', () => (
  <div className="components-container -spaced -width-200">
    <State store={store}>
      <Dropdown
        variant="panel"
...
storiesOf('Dropdown', module).addWithJSX('With caret arrowType and placement', () => (
  <div className="components-container -spaced -width-200">
    <State store={store}>
      <Dropdown
        label="colors"
...
storiesOf('Dropdown', module).addWithJSX('With icon prop in the options', () => (
  <div className="components-container -spaced -width-200">
...
storiesOf('Dropdown', module).addWithJSX('Only view dropdown', () => (
  <div className="components-container -spaced -width-200">
    <State store={store}>
      <Dropdown
        label="colors"
...
storiesOf('Dropdown', module).addWithJSX('With children', () => (
  <div className="components-container -spaced -width-200">
