...
storiesOf('DashboardWidget', module).addWithJSX('Pie', () => (
  <div className="chart-container">
    <DashboardWidget title="Pie Chart" data={dataPie} meta={meta} chartConfig={config.pie} />
  </div>
));

storiesOf('DashboardWidget', module).addWithJSX('Loading', () => (
  <div className="chart-container">
    <DashboardWidget loading title="Loading chart" />
  </div>
));

storiesOf('DashboardWidget', module).addWithJSX('Error', () => (
  <div className="chart-container">
