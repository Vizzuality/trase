...
storiesOf('GridList', module).addWithJSX('GridList', () => (
...
storiesOf('GridList', module).addWithJSX('Items with tooltips', () => (
  <div className="components-container" style={{ width: 760 }}>
    <State store={store}>
      <GridList
        width={760}
...
storiesOf('GridList', module).addWithJSX('Items by groups', () => (
  <div className="components-container" style={{ width: 760 }}>
    <State store={store}>
      <GridList
        width={760}
...
storiesOf('GridList', module).addWithJSX('Loading', () => (
  <div className="components-container" style={{ width: 760 }}>
    <State store={store}>
      <GridList
        width={760}
...
storiesOf('GridList', module).addWithJSX('Disabled', () => (
  <div className="components-container" style={{ width: 760 }}>
    <State store={store}>
      <GridList
        width={760}
