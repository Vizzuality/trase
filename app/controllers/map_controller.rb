class MapController < ApplicationController
  ...
  def index
    ...
    layers = Layer.select('layer.id as id, attribute_id, COALESCE (inds.frontend_name, quants.frontend_name) as name, attribute_type as type, bucket_3, bucket_5, layer.layer_group_id as group_id, COALESCE (inds.unit, quants.unit) as unit, is_default')
