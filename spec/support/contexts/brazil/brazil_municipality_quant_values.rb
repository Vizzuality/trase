shared_context 'brazil municipality quant values' do
  ...
  let!(:land_conflicts_value) do
    FactoryBot.create(:node_quant, node: municipality_node, quant: land_conflicts, value: 0)
  end
  let!(:force_labour_value) do
    FactoryBot.create(:node_quant, node: municipality_node, quant: force_labour, value: 0)
  end
  let!(:embargoes_value) do
    FactoryBot.create(:node_quant, node: municipality_node, quant: embargoes, value: 0)
  end
  # let!(:fob_value) {
  #   FactoryBot.create(:node_quant, node: municipality_node, quant: fob, value: 0)
  # }
