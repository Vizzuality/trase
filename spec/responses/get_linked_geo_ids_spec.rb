...
RSpec.describe 'Get linked geo ids', type: :request do
  ...
  describe 'GET /api/v2/get_linked_geoids' do
    it 'requires a context_id' do
      get '/api/v2/get_linked_geoids', params: @valid_params.reject { |key| key == :context_id }
    ...
    it 'requires target_column_id' do
      get '/api/v2/get_linked_geoids', params: @valid_params.reject { |key| key == :target_column_id }
    ...
    it 'requires years' do
      get '/api/v2/get_linked_geoids', params: @valid_params.reject { |key| key == :years }
    ...
    it 'returns 404 on non-existent context_id' do
      expect { get '/api/v2/get_linked_geoids', params: {context_id: context.id - 100} }.to raise_error(ActiveRecord::RecordNotFound)
    end

    it 'has the correct response structure' do
      get '/api/v2/get_linked_geoids', params: @valid_params
