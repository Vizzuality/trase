...
RSpec.describe 'Get importer node attributes', type: :request do
  ...
  describe 'GET /api/v2/get_actor_node_attributes' do
    ...
    it 'validates node types' do
      ...
      expect { get '/api/v2/get_actor_node_attributes', params: {:context_id => context.id, :node_id => importer1_node.id } }.to_not raise_error()
    end
    ...
    it 'has the correct response structure' do
      get '/api/v2/get_actor_node_attributes', params: {:context_id => context.id, :node_id => importer1_node.id}
