...
RSpec.describe 'Get indicators', type: :request do
  ...
  describe 'GET /indicators' do
    ...
    it 'returns 404 on non-existent context_id' do
      expect { get '/api/v2/indicators', params: {context_id: context.id - 100} }.to raise_error(ActiveRecord::RecordNotFound)
    end

    it 'has the correct response structure' do
      get '/api/v2/indicators', params: {context_id: context.id}
