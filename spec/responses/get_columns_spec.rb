...
RSpec.describe 'Get columns', type: :request do
  ...
  describe 'GET /api/v2/get_columns' do
    it 'requires a context_id' do
      get '/api/v2/get_columns'
    ...
    it 'returns 404 on non-existent context_id' do
      expect { get '/api/v2/get_columns', params: {:context_id => context.id - 100} }.to raise_error(ActiveRecord::RecordNotFound)
    end

    it 'has the correct response structure' do
      get '/api/v2/get_columns', params: {:context_id => context.id}
