...
RSpec.describe 'Get node attributes', type: :request do
  ...
  describe 'GET /api/v3/get_node_attributes' do
    it 'requires a context_id' do
      get '/api/v3/get_node_attributes'
    ...
    it 'returns 404 on non-existent context_id' do
      expect { get '/api/v3/get_node_attributes', params: {:context_id => context.id - 100} }.to raise_error(ActiveRecord::RecordNotFound)
    end

    it 'requires a start_year' do
      get '/api/v3/get_node_attributes', params: {:context_id => context.id}
    ...
    it 'requires a end_year' do
      get '/api/v3/get_node_attributes', params: {:context_id => context.id, :start_year => 2015}
    ...
    it 'has the correct response structure' do
      get '/api/v3/get_node_attributes', params: {:context_id => context.id, :start_year => 2015, :end_year => 2015}
