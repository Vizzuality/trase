...
RSpec.describe 'Get all nodes', type: :request do
  ...
  describe 'GET /get_all_nodes' do
    ...
    it 'returns 404 on non-existent context_id' do
      expect { get '/get_all_nodes', params: {context_id: context.id - 100} }.to raise_error(ActiveRecord::RecordNotFound)
    end

    it 'has the correct response structure' do
      get '/get_all_nodes', params: {context_id: context.id}
