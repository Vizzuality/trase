...
RSpec.describe "Charts::SingleYearNcontNodeTypeView", type: :request do
  ...
  describe "GET /api/v3/dashboards/charts/single_year_ncont_node_type_view" do
    let(:url) { "/api/v3/dashboards/charts/single_year_ncont_node_type_view" }
    let(:filter_params) {
      {
    ...
    it "has the correct response structure" do
      ...
      expect(@response).to match_response_schema("dashboards_charts_single_year_ncont_node_type_view")
    end
  end
end
