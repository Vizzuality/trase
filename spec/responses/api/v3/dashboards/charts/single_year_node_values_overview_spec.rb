...
RSpec.describe 'Charts::SingleYearNodeValuesOverview', type: :request do
  ...
  describe 'GET /api/v3/dashboards/charts/single_year_node_values_overview' do
    let(:url) { '/api/v3/dashboards/charts/single_year_node_values_overview' }
    let(:filter_params) {
      {
    ...
    it 'has the correct response structure' do
      ...
      expect(@response).to match_response_schema('dashboards_charts_single_year_node_values_overview')
    end
  end
end
