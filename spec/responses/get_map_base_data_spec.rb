...
RSpec.describe 'Get map base data', type: :request do
  ...
  describe 'GET /api/v2/get_map_base_data' do
    it 'requires a context_id' do
      get '/api/v2/get_map_base_data'
    ...
    it 'returns 404 on non-existent context_id' do
      expect { get '/api/v2/get_map_base_data', params: {context_id: context.id - 100} }.to raise_error(ActiveRecord::RecordNotFound)
    end

    it 'has the correct response structure' do
      get '/api/v2/get_map_base_data', params: {context_id: context.id}
