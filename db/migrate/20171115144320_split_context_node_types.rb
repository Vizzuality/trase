class SplitContextNodeTypes < ActiveRecord::Migration[5.0]
  ...
  def down
    with_search_path('revamp') do
      ...
      add_column :context_node_types, :column_group, :integer, null: false
      add_column :context_node_types, :is_default, :boolean, null: false, default: false
      add_column :context_node_types, :is_geo_column, :boolean, null: false, default: false
    end
  end
end
