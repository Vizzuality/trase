  ...
  def up
    with_search_path('revamp') do
      create_table :node_attributes do |t|
        ...
        t.references :attribute, null: false, foreign_key: {on_delete: :cascade}, index: true
        t.timestamps
      end
      ...
      create_table :node_attributes_double_values do |t|
        t.references :node_attribute, null: false, foreign_key: {on_delete: :cascade}, index: true
        t.integer :year
