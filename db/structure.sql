...
--
-- Name: trase_main; Type: SERVER; Schema: -; Owner: -
--

CREATE SERVER trase_main FOREIGN DATA WRAPPER postgres_fdw OPTIONS (
    dbname 'trase_core',
    host 'localhost',
    port ''
);
...
--
-- Name: USER MAPPING postgres SERVER trase_main; Type: USER MAPPING; Schema: -; Owner: -
--

CREATE USER MAPPING FOR postgres SERVER trase_main OPTIONS (
    "user" 'main_ro'
);
...
--
-- Name: commodities; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE commodities (
    id integer,
    name text,
...
ALTER FOREIGN TABLE commodities ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE commodities ALTER COLUMN name OPTIONS (
    column_name 'name'
);
ALTER FOREIGN TABLE commodities ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: context_node_types; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE context_node_types (
    id bigint,
    context_id integer,
    node_type_id bigint,
...
OPTIONS (
    schema_name 'trase',
    table_name 'context_node_types'
);
ALTER FOREIGN TABLE context_node_types ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE context_node_types ALTER COLUMN context_id OPTIONS (
    column_name 'context_id'
);
ALTER FOREIGN TABLE context_node_types ALTER COLUMN node_type_id OPTIONS (
    column_name 'node_type_id'
);
ALTER FOREIGN TABLE context_node_types ALTER COLUMN column_position OPTIONS (
    column_name 'column_position'
);
ALTER FOREIGN TABLE context_node_types ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: contexts; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE contexts (
    id integer,
    country_id integer,
...
ALTER FOREIGN TABLE contexts ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE contexts ALTER COLUMN country_id OPTIONS (
    column_name 'country_id'
);
ALTER FOREIGN TABLE contexts ALTER COLUMN commodity_id OPTIONS (
    column_name 'commodity_id'
);
ALTER FOREIGN TABLE contexts ALTER COLUMN years OPTIONS (
    column_name 'years'
);
...
--
-- Name: countries; Type: FOREIGN TABLE; Schema: main; Owner: -
--
...
ALTER FOREIGN TABLE countries ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE countries ALTER COLUMN name OPTIONS (
    column_name 'name'
);
ALTER FOREIGN TABLE countries ALTER COLUMN iso2 OPTIONS (
    column_name 'iso2'
);
ALTER FOREIGN TABLE countries ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: download_versions; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE download_versions (
    id integer,
    context_id integer,
...
OPTIONS (
    schema_name 'trase',
    table_name 'download_versions'
);
ALTER FOREIGN TABLE download_versions ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE download_versions ALTER COLUMN context_id OPTIONS (
    column_name 'context_id'
);
ALTER FOREIGN TABLE download_versions ALTER COLUMN symbol OPTIONS (
    column_name 'symbol'
);
ALTER FOREIGN TABLE download_versions ALTER COLUMN is_current OPTIONS (
    column_name 'is_current'
);
ALTER FOREIGN TABLE download_versions ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: flow_inds; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE flow_inds (
    id bigint,
    flow_id integer,
    ind_id integer,
...
OPTIONS (
    schema_name 'trase',
    table_name 'flow_inds'
);
ALTER FOREIGN TABLE flow_inds ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE flow_inds ALTER COLUMN flow_id OPTIONS (
    column_name 'flow_id'
);
ALTER FOREIGN TABLE flow_inds ALTER COLUMN ind_id OPTIONS (
    column_name 'ind_id'
);
ALTER FOREIGN TABLE flow_inds ALTER COLUMN value OPTIONS (
    column_name 'value'
);
ALTER FOREIGN TABLE flow_inds ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: flow_quals; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE flow_quals (
    id bigint,
    flow_id integer,
    qual_id integer,
    value text,
...
OPTIONS (
    schema_name 'trase',
    table_name 'flow_quals'
);
ALTER FOREIGN TABLE flow_quals ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE flow_quals ALTER COLUMN flow_id OPTIONS (
    column_name 'flow_id'
);
ALTER FOREIGN TABLE flow_quals ALTER COLUMN qual_id OPTIONS (
    column_name 'qual_id'
);
ALTER FOREIGN TABLE flow_quals ALTER COLUMN value OPTIONS (
    column_name 'value'
);
ALTER FOREIGN TABLE flow_quals ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: flow_quants; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE flow_quants (
    id bigint,
    flow_id integer,
    quant_id integer,
    value double precision,
...
OPTIONS (
    schema_name 'trase',
    table_name 'flow_quants'
);
ALTER FOREIGN TABLE flow_quants ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE flow_quants ALTER COLUMN flow_id OPTIONS (
    column_name 'flow_id'
);
ALTER FOREIGN TABLE flow_quants ALTER COLUMN quant_id OPTIONS (
    column_name 'quant_id'
);
ALTER FOREIGN TABLE flow_quants ALTER COLUMN value OPTIONS (
    column_name 'value'
);
ALTER FOREIGN TABLE flow_quants ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: flows; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE flows (
    id integer,
    context_id integer,
    year integer,
    path bigint[],
...
ALTER FOREIGN TABLE flows ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE flows ALTER COLUMN context_id OPTIONS (
    column_name 'context_id'
);
ALTER FOREIGN TABLE flows ALTER COLUMN year OPTIONS (
    column_name 'year'
);
ALTER FOREIGN TABLE flows ALTER COLUMN path OPTIONS (
    column_name 'path'
);
ALTER FOREIGN TABLE flows ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: inds; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE inds (
    id integer,
    name text,
    unit text,
    created_at timestamp with time zone
...
ALTER FOREIGN TABLE inds ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE inds ALTER COLUMN name OPTIONS (
    column_name 'name'
);
ALTER FOREIGN TABLE inds ALTER COLUMN unit OPTIONS (
    column_name 'unit'
);
ALTER FOREIGN TABLE inds ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: node_inds; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE node_inds (
    id bigint,
    node_id bigint,
    ind_id integer,
    year integer,
...
OPTIONS (
    schema_name 'trase',
    table_name 'node_inds'
);
ALTER FOREIGN TABLE node_inds ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE node_inds ALTER COLUMN node_id OPTIONS (
    column_name 'node_id'
);
ALTER FOREIGN TABLE node_inds ALTER COLUMN ind_id OPTIONS (
    column_name 'ind_id'
);
ALTER FOREIGN TABLE node_inds ALTER COLUMN year OPTIONS (
    column_name 'year'
);
ALTER FOREIGN TABLE node_inds ALTER COLUMN value OPTIONS (
    column_name 'value'
);
ALTER FOREIGN TABLE node_inds ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: node_quals; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE node_quals (
    id bigint,
    node_id bigint,
    qual_id integer,
    year integer,
...
OPTIONS (
    schema_name 'trase',
    table_name 'node_quals'
);
ALTER FOREIGN TABLE node_quals ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE node_quals ALTER COLUMN node_id OPTIONS (
    column_name 'node_id'
);
ALTER FOREIGN TABLE node_quals ALTER COLUMN qual_id OPTIONS (
    column_name 'qual_id'
);
ALTER FOREIGN TABLE node_quals ALTER COLUMN year OPTIONS (
    column_name 'year'
);
ALTER FOREIGN TABLE node_quals ALTER COLUMN value OPTIONS (
    column_name 'value'
);
ALTER FOREIGN TABLE node_quals ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: node_quants; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE node_quants (
    id bigint,
    node_id bigint,
    quant_id integer,
    year integer,
...
OPTIONS (
    schema_name 'trase',
    table_name 'node_quants'
);
ALTER FOREIGN TABLE node_quants ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE node_quants ALTER COLUMN node_id OPTIONS (
    column_name 'node_id'
);
ALTER FOREIGN TABLE node_quants ALTER COLUMN quant_id OPTIONS (
    column_name 'quant_id'
);
ALTER FOREIGN TABLE node_quants ALTER COLUMN year OPTIONS (
    column_name 'year'
);
ALTER FOREIGN TABLE node_quants ALTER COLUMN value OPTIONS (
    column_name 'value'
);
ALTER FOREIGN TABLE node_quants ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: node_types; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE node_types (
    id bigint,
    name text,
    created_at timestamp with time zone
)
...
ALTER FOREIGN TABLE node_types ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE node_types ALTER COLUMN name OPTIONS (
    column_name 'name'
);
ALTER FOREIGN TABLE node_types ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: nodes; Type: FOREIGN TABLE; Schema: main; Owner: -
--
...
ALTER FOREIGN TABLE nodes ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE nodes ALTER COLUMN main_id OPTIONS (
    column_name 'main_id'
);
ALTER FOREIGN TABLE nodes ALTER COLUMN node_type_id OPTIONS (
    column_name 'node_type_id'
);
ALTER FOREIGN TABLE nodes ALTER COLUMN name OPTIONS (
    column_name 'name'
);
ALTER FOREIGN TABLE nodes ALTER COLUMN geo_id OPTIONS (
    column_name 'geo_id'
);
ALTER FOREIGN TABLE nodes ALTER COLUMN is_unknown OPTIONS (
    column_name 'is_unknown'
);
ALTER FOREIGN TABLE nodes ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: quals; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE quals (
    id integer,
    name text,
    created_at timestamp with time zone
)
...
ALTER FOREIGN TABLE quals ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE quals ALTER COLUMN name OPTIONS (
    column_name 'name'
);
ALTER FOREIGN TABLE quals ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);


--
-- Name: quants; Type: FOREIGN TABLE; Schema: main; Owner: -
--

CREATE FOREIGN TABLE quants (
    id integer,
    name text,
    unit text,
    created_at timestamp with time zone
...
ALTER FOREIGN TABLE quants ALTER COLUMN id OPTIONS (
    column_name 'id'
);
ALTER FOREIGN TABLE quants ALTER COLUMN name OPTIONS (
    column_name 'name'
);
ALTER FOREIGN TABLE quants ALTER COLUMN unit OPTIONS (
    column_name 'unit'
);
ALTER FOREIGN TABLE quants ALTER COLUMN created_at OPTIONS (
    column_name 'created_at'
);
