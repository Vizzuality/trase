...
--
-- Name: methods_and_data_docs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.methods_and_data_docs (
    id bigint NOT NULL,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    context_id bigint NOT NULL,
...
--
-- Name: methods_and_data_docs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.methods_and_data_docs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: methods_and_data_docs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.methods_and_data_docs_id_seq OWNED BY public.methods_and_data_docs.id;
...
--
-- Name: methods_and_data_docs id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.methods_and_data_docs ALTER COLUMN id SET DEFAULT nextval('public.methods_and_data_docs_id_seq'::regclass);
...
--
-- Name: methods_and_data_docs methods_and_data_docs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.methods_and_data_docs
    ADD CONSTRAINT methods_and_data_docs_pkey PRIMARY KEY (id);
...
--
-- Name: index_methods_and_data_docs_on_context_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_methods_and_data_docs_on_context_id ON public.methods_and_data_docs USING btree (context_id);
...
--
-- Name: methods_and_data_docs fk_rails_bb411dfc74; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.methods_and_data_docs
    ADD CONSTRAINT fk_rails_bb411dfc74 FOREIGN KEY (context_id) REFERENCES public.contexts(id) ON DELETE CASCADE;
